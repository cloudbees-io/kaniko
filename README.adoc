...
Use this action uses link:https://github.com/GoogleContainerTools/kaniko[Kaniko]to build images based upon a Dockerfile then publish the image to a Docker registry.  This action also reports the image and tag names to the workflow run for artifact traceability purposes.
